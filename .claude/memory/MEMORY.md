...
- [npm Vulnerability Backlog — 15 remaining](project_vuln_backlog.md) — post-Vite-migration vulns: Vite 6.5+, react-router-dom, @typescript-eslint, sort-by, puppeteer. Ordered by upgrade risk.
