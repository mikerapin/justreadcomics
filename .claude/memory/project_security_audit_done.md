...
**~107 npm audit vulnerabilities.** All pre-existing, sourced from CRA and AWS SDK v3 peer deps. `npm audit fix --force` would break CRA. Needs a proper CRA-to-Vite migration or selective overrides.
